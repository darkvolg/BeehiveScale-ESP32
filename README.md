...
![Version](https://img.shields.io/badge/version-v5.0.21-f5a623?style=flat-square)
...
2. **На LCD** появится splash «Vesy Pchelovod v5.0.21».
...
- [x] Пресет «С прошлого визита» (v5.0.21)
