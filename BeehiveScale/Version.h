...
#define FW_VERSION_SUFFIX ""  // 5.0.11 — fix: web UI ярче (text3+text2 → #a5b894, контраст ~9:1, AAA), дата фиксации вынесена в отдельный блок (не переносится на 2 строки).
