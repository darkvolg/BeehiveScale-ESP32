...
// v5.0.69: выгрузка за диапазон в виде таблицы, которую Excel открывает С ЦВЕТАМИ.
// Формат — HTML-таблица с инлайн-стилями, отдаётся под именем *.xls. Excel и
// LibreOffice понимают его как книгу и сохраняют заливку/цвет шрифта; настоящий
// XLSX (zip+xml) на ESP32 не собрать без кучи heap. Раскраска считается здесь же,
